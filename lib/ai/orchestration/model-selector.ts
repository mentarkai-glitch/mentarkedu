...
const MODEL_REGISTRY: Record<AIModel, ModelCapabilities> = {
  'gpt-4o': {
    ...
    costPerRequest: 0,
    strengths: ['roadmap', 'mentor_chat', 'resource_recommendation', 'research'],
    languages: ['en'],
  ...
  'claude-sonnet': {
    ...
    costPerToken: 0.000003,
    costPerRequest: 0,
    strengths: ['mentor_chat', 'emotion', 'research', 'insights'],
    languages: ['en'],
  ...
  'gemini-pro': {
    ...
    costPerRequest: 0,
    strengths: ['research', 'insights', 'mentor_chat'],
    languages: ['en'],
  ...
  'gemini-2.5-flash': {
    ...
    costPerRequest: 0,
    strengths: ['mentor_chat', 'resource_recommendation', 'research'],
    languages: ['en'],
    features: ['reasoning', 'analysis'],
    uptime: 99.8,
    avgResponseTime: 800,
  ...
  'gpt-4o-mini': {
    ...
    costPerRequest: 0,
    strengths: ['mentor_chat', 'resource_recommendation'],
    languages: ['en'],
