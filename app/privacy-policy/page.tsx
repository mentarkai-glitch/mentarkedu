...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-card-foreground overflow-x-hidden">
      <Header />
      <div className="pt-16">
        <div className="container mx-auto max-w-4xl px-4 py-16 space-y-12">
          ...
          >
            ...
            <Button asChild className="bg-gradient-to-r from-cyan-400 to-blue-500 text-black font-semibold hover:opacity-90">
